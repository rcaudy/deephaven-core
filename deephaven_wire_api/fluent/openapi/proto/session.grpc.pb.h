...
//
// Flight's Ticket is the id that represents a specific export.
...
//
// All Deephaven tickets are 8-byte signed longs.
//
 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status CloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest& request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::io::deephaven::proto::backplane::grpc::ReleaseResponse>> AsyncCloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::io::deephaven::proto::backplane::grpc::ReleaseResponse>>(AsyncCloseSessionRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::io::deephaven::proto::backplane::grpc::ReleaseResponse>> PrepareAsyncCloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::io::deephaven::proto::backplane::grpc::ReleaseResponse>>(PrepareAsyncCloseSessionRaw(context, request, cq));
    }
    //
    ...
    class experimental_async_interface {
     public:
      ...
      // Proactively close an open session. Sessions will automatically close on timeout. When a session is closed, all
      // unreleased exports will be automatically released.
      virtual void CloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void CloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void CloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      //
      // Attempts to release an export by its ticket. Returns true if an existing export was found. It is the client's
      // responsibility to release all resources they no longer want the server to hold on to.
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status CloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest& request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::io::deephaven::proto::backplane::grpc::ReleaseResponse>> AsyncCloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::io::deephaven::proto::backplane::grpc::ReleaseResponse>>(AsyncCloseSessionRaw(context, request, cq));
    }
    ...
    class experimental_async final :
     ...
     public:
      ...
      #endif
      void CloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void CloseSession(::grpc::ClientContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // Proactively close an open session. Sessions will automatically close on timeout. When a session is closed, all
    // unreleased exports will be automatically released.
    virtual ::grpc::Status CloseSession(::grpc::ServerContext* context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response);
    //
    // Attempts to release an export by its ticket. Returns true if an existing export was found. It is the client's
    // responsibility to release all resources they no longer want the server to hold on to.
  ...
  class WithAsyncMethod_CloseSession : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CloseSession(::grpc::ServerContext* /*context*/, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* /*request*/, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestCloseSession(::grpc::ServerContext* context, ::io::deephaven::proto::backplane::grpc::HandshakeRequest* request, ::grpc::ServerAsyncResponseWriter< ::io::deephaven::proto::backplane::grpc::ReleaseResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_NewSession<WithAsyncMethod_RefreshSessionToken<WithAsyncMethod_CloseSession<WithAsyncMethod_Release<WithAsyncMethod_ExportNotifications<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  class ExperimentalWithCallbackMethod_CloseSession : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_CloseSession() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(2,
          new ::grpc::internal::CallbackUnaryHandler< ::io::deephaven::proto::backplane::grpc::HandshakeRequest, ::io::deephaven::proto::backplane::grpc::ReleaseResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* request, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* response) { return this->CloseSession(context, request, response); }));}
    void SetMessageAllocatorFor_CloseSession(
        ::grpc::experimental::MessageAllocator< ::io::deephaven::proto::backplane::grpc::HandshakeRequest, ::io::deephaven::proto::backplane::grpc::ReleaseResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(2);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(2);
    #endif
      static_cast<::grpc::internal::CallbackUnaryHandler< ::io::deephaven::proto::backplane::grpc::HandshakeRequest, ::io::deephaven::proto::backplane::grpc::ReleaseResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* CloseSession(
      ::grpc::CallbackServerContext* /*context*/, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* /*request*/, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* CloseSession(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::io::deephaven::proto::backplane::grpc::HandshakeRequest* /*request*/, ::io::deephaven::proto::backplane::grpc::ReleaseResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_NewSession<ExperimentalWithCallbackMethod_RefreshSessionToken<ExperimentalWithCallbackMethod_CloseSession<ExperimentalWithCallbackMethod_Release<ExperimentalWithCallbackMethod_ExportNotifications<Service > > > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_NewSession<ExperimentalWithCallbackMethod_RefreshSessionToken<ExperimentalWithCallbackMethod_CloseSession<ExperimentalWithCallbackMethod_Release<ExperimentalWithCallbackMethod_ExportNotifications<Service > > > > > ExperimentalCallbackService;
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_CloseSession() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler<
          ::io::deephaven::proto::backplane::grpc::HandshakeRequest, ::io::deephaven::proto::backplane::grpc::ReleaseResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::io::deephaven::proto::backplane::grpc::HandshakeRequest, ::io::deephaven::proto::backplane::grpc::ReleaseResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedCloseSession(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::io::deephaven::proto::backplane::grpc::HandshakeRequest,::io::deephaven::proto::backplane::grpc::ReleaseResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_NewSession<WithStreamedUnaryMethod_RefreshSessionToken<WithStreamedUnaryMethod_CloseSession<WithStreamedUnaryMethod_Release<WithSplitStreamingMethod_ExportNotifications<Service > > > > > StreamedService;
};
