#include "highlevel/expressions.h"
...
DateTimeExpression::DateTimeExpression(boost::string_view value) :
    DateTimeExpression(impl::DateTimeExpressionImpl::createFromLiteral(value.to_string())) {}
