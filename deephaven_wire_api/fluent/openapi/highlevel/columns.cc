...
SortPair SortPair::ascending(boost::string_view columnName, bool abs) {
  return SortPair(columnName.to_string(), SortDirection::Ascending, abs);
}
...
SortPair SortPair::descending(boost::string_view columnName, bool abs) {
  return SortPair(columnName.to_string(), SortDirection::Descending, abs);
}
